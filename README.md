<img width="1919" height="799" alt="image" src="https://github.com/user-attachments/assets/ec5d20e7-ce7c-4822-aa48-4b3e87006455" />

# SSF2 Delta - Final Re:Mix
*SSF2 Delta - Final Re:Mix* is a remaster of the **original** SSF2 Delta, initially released in 2020 - a modpack that aimed to rework the entire playable cast of SSF2 with exciting tweaks to make everyone competitively viable. The theme of the project was "change", which is why I gave it the name of Delta!
...
- Compiled for 64-bit machines (this should also help/fix the old memory leak issues)
